...
declare type ApparatusObservation =
  | number[]
...
declare class ApparatusBayesClassifier extends ApparatusClassifier {
  ...
  getClassifications(
    observation: ApparatusObservation
  ): ApparatusClassification[];
  probabilityOfClass(observation: ApparatusObservation, label: string): number;
  static restore(
    classifier: string | ApparatusBayesClassifier
  ): ApparatusBayesClassifier;
}
...
declare class ApparatusLogisticRegressionClassifier extends ApparatusClassifier {
  ...
  static restore(
    classifier: string | ApparatusLogisticRegressionClassifier
...
declare type ClassifierCallback = (
...
declare class ClassifierBasePromise extends ClassifierBase {
  train(): Promise<void>;
}

declare type BayesClassifierCallback = (
  err: NodeJS.ErrnoException | null,
...
declare type LogisticRegressionClassifierCallback = (
  err: NodeJS.ErrnoException | null,
...
declare type LogisticRegressionWorkersClassifierCallback = (
  err: NodeJS.ErrnoException | null,
  classifier?: LogisticRegressionWorkersClassifier
) => void;

export class LogisticRegressionWorkersClassifier extends ClassifierBasePromise {
  constructor(numWorkers: number, stemmer?: Stemmer);
  static load(
    filename: string,
    stemmer: Stemmer | null | undefined,
    callback: LogisticRegressionWorkersClassifierCallback
  ): void;
  static restore(
    classifier: LogisticRegressionWorkersClassifier,
    stemmer?: Stemmer
  ): LogisticRegressionWorkersClassifier;
}

declare type MaxEntClassifierCallback = (
  err: NodeJS.ErrnoException | null,
  classifier?: MaxEntClassifier | null
) => void;
...
export class MaxEntClassifier {
  ...
  load(
    filename: string,
    elementClass: Element,
    callback: MaxEntClassifierCallback
  ): void;
}
